...
`SwiftUI` `WidgetKit` `Vision`

**[우리의 거점 ↗](https://swunmd2026.com)**  
서울여자대학교 첨단미디어디자인전공 제2회 졸업전시 웹사이트  
`Next.js` `TypeScript`

**[RiseUp](https://github.com/jmseooo/riseupapp)**  
내일의 일출 시각에 맞춰 깨워 주는 iOS 알람 앱  
...
[www.linkedin.com/in/jinminseo](https://www.linkedin.com/in/jinminseo) · [jmseooo_@naver.com](mailto:jmseooo_@naver.com)
